...
public class TestBanking extends Bank {
    public static void main(String[] args) {
        ...
        bank.getCustomers().get(0).addAccount(new SavingAccount(500.0, 0.05));
        ...
        bank.getCustomers().get(2).addAccount(new SavingAccount(1500.0, 0.05));
        bank.getCustomers().get(2).addAccount(new CheckingAccount(300.0));
        bank.getCustomers().get(3).addAccount(new SavingAccount(150.0, 0.05));
